...
use xed_sys2::{
    ...
    xed_inst_operand, xed_inst_t, xed_mem_gbisd, xed_operand_is_register, xed_operand_name,
    xed_operand_operand_visibility, xed_operand_t, xed_operand_type, xed_operand_width,
